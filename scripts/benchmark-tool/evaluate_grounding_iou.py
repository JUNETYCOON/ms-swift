    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for threshold in self.thresholds:
            ...
            result["thresholds"][key] = {
                ...
                "complete_iou_accuracy": safe_div(self.exact_set_records[threshold], self.scored_rows),
                "c_iou": safe_div(self.exact_set_records[threshold], self.scored_rows),
...
def main() -> int:
    ...
    print(
        ...
        f"c_iou={threshold_metrics['c_iou']:.4f} "
